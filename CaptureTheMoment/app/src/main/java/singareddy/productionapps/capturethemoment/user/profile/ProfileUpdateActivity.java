...
import static singareddy.productionapps.capturethemoment.utils.AppUtilities.ScreenTitles.SCREEN_TITLE_EDIT_PROFILE;
...
public class ProfileUpdateActivity extends AppCompatActivity implements View.OnClickListener, ProfileListener {
    ...
    private void initialiseUI() {
        getSupportActionBar().setTitle(SCREEN_TITLE_EDIT_PROFILE);
